...
public class RegByMailRegUI extends Activity {
	 ...
	 private MMImageButton cancelBtn,nextBtn;
		...
		public void initMobilReg(){
			...
			title.setText(R.string.regbymail_reg_title);
			
		}
		public class MailRegOnClickListener implements View.OnClickListener{
			...
			public void onClick(View v) {
				...
				case R.id.title_btn1:
					Intent intent=new Intent(RegByMailRegUI.this,MainTabUI3.class);
