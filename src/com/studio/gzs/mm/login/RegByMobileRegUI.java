...
public class RegByMobileRegUI extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		content_lv=inflater.inflate(R.layout.regbymobile_reg, null);//µÇÂ¼	
	...
	public void initMobilReg(){
		...
		title.setText(R.string.regbymoile_reg_title);
	...
	public class MoblieRegOnClickListener implements View.OnClickListener{
		...
		public void onClick(View v) {
			...
			case R.id.title_btn1:
				Intent intent=new Intent(RegByMobileRegUI.this,RegByMobileSetPwdUI.class);
