...
public class RegByMobileSetPwdUI extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		content_lv=inflater.inflate(R.layout.regbymobilesetpwd_reg, null);//µÇÂ¼	
	...
	public void init(){
		...
		title.setText(R.string.regbymobile_reg_setpwd_title);
	...
	public class MoblieRegOnClickListener implements View.OnClickListener{
		...
		public void onClick(View v) {
			...
			case R.id.title_btn1:
				Intent intent=new Intent(RegByMobileSetPwdUI.this,RegByMobileSetNickUI.class);
